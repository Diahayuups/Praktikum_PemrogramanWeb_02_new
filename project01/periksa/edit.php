                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Form Periksa</h3>
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="pasien_id" class="col-4 col-form-label">Pasien A.N</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row">
                                    <label for="dokter_id" class="col-4 col-form-label">Dokter A.N</label>
                                    <div class="col-8">
