            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h1 class="text-center">Form Pendaftaran IT Clubs Data Sciene</h1><br>
                            <form method="POST" action="praktikum03.php">
                                ...
                                <div class="form-group row">
                                    <label for="prodi" class="col-4 col-form-label font-weight-bold">Program
                                        Studi</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row">
                                    <label for="domisili" class="col-4 col-form-label font-weight-bold">Tempat
                                        Domisili</label>
                                    <div class="col-8">
